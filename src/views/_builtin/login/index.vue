<template>
  <div class="relative flex-center wh-full" :style="{ backgroundColor: bgColor, backgroundImage: bgImage }">
    <dark-mode-switch
      :dark="theme.darkMode"
...
const bgImage = computed(() =>
  theme.darkMode ? 'url(../public/g8_login_dark.svg)' : 'url(../public/g8_login_light.svg)'
);

const bgColor = computed(() => {
  const COLOR_WHITE = '#ffffff';
  const ratio = theme.darkMode ? 0.5 : 0.1;
